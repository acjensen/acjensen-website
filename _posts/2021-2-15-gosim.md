...
We can break the second order differential equation into two first-order differential equations by defining $$s_1$$ and $$s_2$$.

$$s_1 = \dot{\theta}$$

$$s_2 = \dot{s}_1 = \ddot{\theta} = \frac{-g}{L}\sin{s_1}$$
